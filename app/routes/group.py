...
# Manages routes related to group chat functionalities,
#  including creating groups,
#  adding members, sending messages, listing groups, and deleting groups.
...
#   This file interacts with the Group, 
#       User, and GroupMessage models to manage group creation, membership, and messaging.
#    Enforces group membership rules and validates user actions within a group.
...
# Only the group creator can add new member
...
# Sends a message within a specific group.
# Validates that the user sending the message is a member of the group.
...
# Lists all groups that the authenticated user is a member of.
def list_my_groups():
    current_user_id = get_jwt_identity()
